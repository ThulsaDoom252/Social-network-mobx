...
import {photoFilterEnum, statusFilterEnum} from "../../context/filterModes";
...
interface SearchBarProps {
    ...
    filterByPhotoMode: photoFilterEnum // Filter mode for user photos
    filterByStatusMode: statusFilterEnum // Filter mode for user status
    handleFilterByPhotoMode: (value: photoFilterEnum) => void // Function to handle filter by photo mode change
    handleFilterByStatusMode: (value: statusFilterEnum) => void // Function to handle filter by status mode change
    ...
    return (
        <div className={`w-full mt-2 flex justify-center relative ${isSearchMenuActive ? 'active' : ''}`}>
            ...
            <div
                ...
                onClick={() => {
                    toggleSearchMenu(!isSearchMenuOpen)
                }}
            >
                <ControlOutlined/>
            </div>
